 ...
 */
export function filterTabsByPathname(tabs: SidebarTabWithProps[], pathname: string): SidebarTabWithProps[] {
...
export function NavbarLinkItem({ className, item, ...props }: { item: LinkItemType } & HTMLAttributes<HTMLElement>) {
