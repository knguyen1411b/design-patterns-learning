...
export function DocsLayout(props: DocsLayoutProps) {
    ...
    function sidebar() {
        ...
        const titleNode: ReactNode = typeof nav.title === 'function' ? nav.title({} as ComponentProps<'a'>) : nav.title
        const viewport = (
            <SidebarViewport>
                {links
    ...
    return (
        <TreeContextProvider tree={tree as ComponentProps<typeof TreeContextProvider>['tree']}>
            <LayoutContextProvider
