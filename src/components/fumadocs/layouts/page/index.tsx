...
import { PageBreadcrumb, PageFooter, PageTOCPopover, PageTOCPopoverContent, PageTOCPopoverTrigger } from './client'
...
export function DocsPage({
    ...
    tableOfContentPopover: { component: tocPopover, enabled: tocPopoverEnabled, ...tocPopoverOptions } = {},
    toc = []
}: DocsPageProps) {
...
export function DocsDescription({ children, className, ...props }: ComponentProps<'p'>) {
    ...
    return (
        <p {...props} className={cn('text-fd-muted-foreground text-lg', className)}>
            {children}
        </p>
    )
}
